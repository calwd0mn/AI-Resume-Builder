...
const Testimonial = () => {
  ...
  return (
    <>
      ...
      <div>
        <div id="testmonials" className='flex flex-col items-center my-10 scroll-mt-12' >
          ...
          <Title title="Don't just take our words" description="Hear what out users say about us. We're always looking for ways to imporove. If you have a positive experience with us ,leave a review/" />
