    ...
    return (
        <div className="max-w-4xl mx-auto p-8 bg-white text-gray-800 leading-relaxed">
            ...
            <header className="text-center mb-8 pb-6 border-b-2" style={{ borderColor: accentColor }}>
                ...
                <div >
                    {data.personal_info?.job_intention && (
                        <div className="flex items-center gap-2 font-semibold justify-center mt-2 text-sm text-gray-600">
                            <BriefcaseBusiness className="size-4" />
                            <span className="break-all">{data.personal_info.job_intention}</span>
                        </div>
                    )}
                </div>
            </header>
